        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-dark-surface/40 backdrop-blur-md border border-neon-cyan/20 rounded-xl p-8 md:p-12 text-center reveal-element">
            <h2 className="font-orbitron text-3xl md:text-4xl font-bold mb-4">
              Ready to <span className="bg-clip-text text-transparent bg-gradient-to-r from-neon-blue to-neon-cyan shadow-[0_0_10px_rgba(0,227,255,0.7)]">Detect AI</span> Content?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="border-neon-cyan/30 hover:border-neon-cyan text-white px-8 py-6 hover:bg-transparent">
                Request Demo
              </Button>
            </div>
